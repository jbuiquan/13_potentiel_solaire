...
export const ELU_INTRO_SHORT = (
	<p>
		De nombreuses communes nous ont fait remonter leurs difficultés à financer ces projets, de
		rénovation comme de panneaux photovoltaïques, par manque de moyens financiers mis par
		l’État.
...
export const ELU_INTRO_LONG = (
	<>
		...
		<p>
			...
			former les générations futures aux enjeux de transition énergétique.
		</p>
		<p>
...
export const ELU_BODY = (
	<ul className='list-inside list-disc'>
		<li className='mb-8 mt-2'>
			...
			l’État.
			<span className='font-bold'>
				&nbsp;Si cela est votre cas, nous vous invitons à nous contacter à l’adresse
				suivante
			</span>
			<a
